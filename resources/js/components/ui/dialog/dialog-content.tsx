    ...
    <DialogPortal data-slot="dialog-portal" container={container}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "bg-background fixed top-[50%] left-[50%] z-50 flex w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] flex-col overflow-hidden rounded-xl border shadow-lg duration-300 md:max-w-lg",
