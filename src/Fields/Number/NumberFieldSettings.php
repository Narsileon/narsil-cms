...
use Narsil\Contracts\Fields\Number\NumberFieldSettings as Contract;
 ...
 */
class NumberFieldSettings extends FieldSettings implements Contract
{
    #region CONSTRUCTOR
    ...
    {
        parent::__construct(TypeEnum::NUMBER->value);
