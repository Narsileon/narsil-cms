...
class HeaderPolicy
{
    ...
    {
        $permission = PermissionService::getHandle(Header::TABLE, PermissionEnum::CREATE->value);
    ...
    {
        $permission = PermissionService::getHandle(Header::TABLE, PermissionEnum::DELETE->value);
    ...
    {
        $permission = PermissionService::getHandle(Header::TABLE, PermissionEnum::UPDATE->value);
    ...
    {
        $permission = PermissionService::getHandle(Header::TABLE, PermissionEnum::VIEW->value);
