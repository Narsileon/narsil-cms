...
return [
    ...
    */
    ...
    \Narsil\Contracts\Forms\FormFieldsetElementForm::class => \Narsil\Implementations\Forms\FormFieldsetElementForm::class,
    \Narsil\Contracts\Forms\FormFieldsetForm::class => \Narsil\Implementations\Forms\FormFieldsetForm::class,
    \Narsil\Contracts\Forms\FormForm::class => \Narsil\Implementations\Forms\FormForm::class,
    \Narsil\Contracts\Forms\FormInputForm::class => \Narsil\Implementations\Forms\FormInputForm::class,
