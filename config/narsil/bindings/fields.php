...
return [
    ...
    */
    ...
    \Narsil\Contracts\Fields\EntityField::class => \Narsil\Implementations\Fields\EntityField::class,
    ...
    \Narsil\Contracts\Fields\LinkField::class => \Narsil\Implementations\Fields\LinkField::class,
