...
return [
    ...
    */
    ...
    \Narsil\Contracts\FormRequests\FormFieldsetFormRequest::class => \Narsil\Implementations\Requests\FormFieldsetFormRequest::class,
    \Narsil\Contracts\FormRequests\FormFormRequest::class => \Narsil\Implementations\Requests\FormFormRequest::class,
    \Narsil\Contracts\FormRequests\FormInputFormRequest::class => \Narsil\Implementations\Requests\FormInputFormRequest::class,
