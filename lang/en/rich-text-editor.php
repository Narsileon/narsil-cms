...
return [
    ...
    'toggles' => [
        RichTextEditorEnum::ALIGN_CENTER->value => 'Toggle align center',
        RichTextEditorEnum::ALIGN_JUSTIFY->value => 'Toggle align justify',
        RichTextEditorEnum::ALIGN_LEFT->value => 'Toggle align left',
        RichTextEditorEnum::ALIGN_RIGHT->value => 'Toggle align right',
        RichTextEditorEnum::BOLD->value => 'Toggle bold',
        RichTextEditorEnum::BULLET_LIST->value => 'Toggle bullet list',
        RichTextEditorEnum::HEADING_1->value => 'Toggle heading 1',
        RichTextEditorEnum::HEADING_2->value => 'Toggle heading 2',
        RichTextEditorEnum::HEADING_3->value => 'Toggle heading 3',
        RichTextEditorEnum::HEADING_4->value => 'Toggle heading 4',
        RichTextEditorEnum::HEADING_5->value => 'Toggle heading 5',
        RichTextEditorEnum::HEADING_6->value => 'Toggle heading 6',
        RichTextEditorEnum::ITALIC->value => 'Toggle italic',
        RichTextEditorEnum::ORDERED_LIST->value => 'Toggle ordered list',
        RichTextEditorEnum::STRIKE->value => 'Toggle strike',
        RichTextEditorEnum::SUBSCRIPT->value => 'Toggle subscript',
        RichTextEditorEnum::SUPERSCRIPT->value => 'Toggle superscript',
        RichTextEditorEnum::UNDERLINE->value => 'Toggle underline',
