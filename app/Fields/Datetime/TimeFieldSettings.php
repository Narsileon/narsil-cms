...
namespace App\Fields\Datetime;

#region USE

use App\Contracts\Fields\Datetime\TimeFieldSettings as Contract;
 ...
 */
class TimeFieldSettings extends FieldSettings implements Contract
{
    #region CONSTRUCTOR
    ...
    {
        parent::__construct(TypeEnum::TIME->value);
