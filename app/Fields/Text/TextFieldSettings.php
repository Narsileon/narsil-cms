...
namespace App\Fields\Text;

#region USE

use App\Contracts\Fields\Number\NumberFieldSettings;
use App\Contracts\Fields\Text\TextFieldSettings as Contract;
 ...
 */
class TextFieldSettings extends FieldSettings implements Contract
{
    #region CONSTRUCTOR
    ...
    {
        parent::__construct(TypeEnum::TEXT->value);
    ...
    public function getForm(): array
    {
        return [
            new Field([
                ...
                Field::NAME => trans('validation.attributes.min_length'),
                Field::SETTINGS => app(NumberFieldSettings::class)
                    ->max('255')
                    ->min('0')
                    ->step('1')
                    ->toArray(),
            ...
            new Field([
                ...
                Field::NAME => trans('validation.attributes.max_length'),
                Field::SETTINGS => app(NumberFieldSettings::class)
                    ->max('255')
                    ->min('0')
                    ->step('1')
            ...
            new Field([
                ...
                Field::NAME => trans('validation.attributes.placeholder'),
