...
use App\Contracts\Fields\Text\PasswordFieldSettings as Contract;
 ...
 */
class PasswordFieldSettings extends FieldSettings implements Contract
{
    #region CONSTRUCTOR
    ...
    {
        parent::__construct(TypeEnum::PASSWORD->value);
